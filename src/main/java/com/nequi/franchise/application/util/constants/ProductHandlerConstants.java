package com.nequi.franchise.application.util.constants;

public class ProductHandlerConstants {

    public static final String INVALID_PRODUCT_FIELDS = "All product fields are required";
    ...
    private ProductHandlerConstants() {
    }
}